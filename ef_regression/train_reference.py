...
from af_lvef_regression.dataset import EchoVideoEF #type: ignore
from af_lvef_regression.model import EFRegressor #type: ignore
...
if __name__ == "__main__":
    ...
    train_ds = EchoVideoEF(config, splits=["TRAIN"], fix_samples=True, limit=config.get("limit", -1)) #type: ignore
